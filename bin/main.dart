...
Future<void> main(List<String> arguments) async {
  ...
  final fromFormat =
      prompter.askMultiple('Select conversion format: ', buildFormatOptions());
  final File? selectedFile = prompter.askMultiple(
      'Select the file to convert: ', buildFileOptions(fromFormat));
